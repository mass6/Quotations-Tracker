    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li class="{{ isActive('attributes', 1) }}">{{ link_to_route('attributes.index', 'Attributes') }}</li>
                ...
                <li class="dropdown {{ isActive('quotations') }}">
                    <a href="/users" class="dropdown-toggle" data-toggle="dropdown">Quotations <b class="caret"></b></a>
